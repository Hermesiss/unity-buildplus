...
namespace Trismegistus.BuildPlus {
	...
	public class Version : XmlSerializableData<Version> {
		...
		/// <summary>
		/// Use if release is fixing serious bug or security issue
		...
		public override string ToString() {
			...
			var rev = string.IsNullOrEmpty(revision) ? "" : $"_{revision}";
			return $"{unreleasedStr}{major}.{minor}.{build}{rev} {yankedStr}({dateString})";
		}
